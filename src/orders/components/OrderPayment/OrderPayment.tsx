            ...
            <CardContent>
                <table className={classes.root}>
                    ...
                    <tr>
                        ...
                        <td className={classes.textRight}>
                            {maybe(() => order.subtotal.gross) === undefined ? (
                                ...
                                <Money money={{
                                    amount: sumBy(order.lines, line => line.undiscountedUnitPrice.gross.amount * line.quantity),
                    ...
                    <tr>
                        ...
                        <td className={classes.textRight}>
                            {maybe(() => order.lines.length > 0) === true ? (
                                <Money money={
                                    {
                                        amount: sumBy(order.lines, line => line.unitDiscountValue),
                                        currency: order.total.gross.currency
                                    }
                                }/>
                            ) : (
